...
# 	nvcc $^ -DUSE_DOUBLE_PRECISION $(CFLAGS) $(NVCC_FLAGS) $(NVIDIA4_OPTS) $(LINK) $(GEN_FLAGS) -o bin/cilia_periodic

cilia_nvidia4_CUFCM: $(CILIA_CPP) $(CILIA_CUDA)
	nvcc $^ $(CFLAGS) $(NVCC_FLAGS) $(NVIDIA4_OPTS) $(LINK) $(GEN_FLAGS) -o bin/cilia_periodic