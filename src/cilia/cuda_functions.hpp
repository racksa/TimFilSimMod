...
__global__ void perodic_barrier_forces(double *f_segs, double *f_blobs_repulsion, const double *const x_segs, const double *const x_blobs, const int start_seg, const int num_segs, const int start_blob, const int num_blobs);
